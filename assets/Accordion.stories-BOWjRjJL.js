import{j as e}from"./jsx-runtime-DztICxWZ.js";import{r as m,R as G}from"./index-Bv9Y92EF.js";import{g as d}from"./styled-components.browser.esm-CVW2bgxI.js";import{a as ge,C as ta,E as ia}from"./ExpandMore-Rc_6KUah.js";import{T as a}from"./Typography-CidD3oMh.js";import{c as J}from"./createSvgIcon-Ce6eLUkr.js";import{B as u}from"./Button-DlNRQx8j.js";import{a as n}from"./WarningAmberOutlined-Chc0M3hO.js";import{B as g}from"./Badge-FGqUbZvd.js";import{C as Eo}from"./Chip--FEJIdFJ.js";import{C as ra}from"./Close-CtL5j8iM.js";import"./_commonjsHelpers-Cpj98o6Y.js";const So=J(e.jsx("path",{d:"M9 16.2 4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4z"})),da=J(e.jsx("path",{d:"M6 2v6h.01L6 8.01 10 12l-4 4 .01.01H6V22h12v-5.99h-.01L18 16l-4-4 4-3.99-.01-.01H18V2zm10 14.5V20H8v-3.5l4-4zm-4-5-4-4V4h8v3.5z"})),sa=J(e.jsx("path",{d:"M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8m0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4z"})),ca=d.div`
  display: flex;
...
`,Ta=d.div`
  width: 100%;
  height: 1px;
  background-color: ${({theme:o})=>o.colors.palette.neutral[200]};
`,i=m.forwardRef(({as:o,heading:t="Accordion Heading",headingVariant:s="headingM",headingWeight:h="semibold",description:l,showDescription:Q=!0,children:Z,leadIcon:ee,showLeadIcon:ko=!0,expandIconPosition:oe="right",labelsAndMetadata:ae,showFooter:ne=!1,showFooterLine:Do=!0,showButtons:Ro=!0,footerText:V,footerActions:W,customHeader:te,customContent:ie,customFooter:re,defaultExpanded:Mo=!1,expanded:z,disabled:y=!1,isLoading:U=!1,isInvalid:x=!1,isEmpty:de=!1,errorMessage:se,emptyMessage:$o="No content available",loadingMessage:qo="Loading...",onExpandChange:Y,onOpen:_,onClose:K,onAfterOpen:f,onAfterClose:v,className:Fo,style:No,headerClassName:Po,headerStyle:Bo,contentClassName:Oo,contentStyle:Ho,footerClassName:Vo,footerStyle:Wo,"aria-label":zo,"aria-labelledby":Uo,"aria-describedby":Yo,id:_o,...Ko},Xo)=>{const Go=m.useId(),b=_o||Go,ce=`${b}-header`,le=`${b}-content`,pe=l&&Q?`${b}-description`:void 0,[Jo,Qo]=m.useState(Mo),r=z!==void 0?z:Jo,he=m.useRef(r),Zo=o||"div",X=()=>{if(y)return;const c=!r;c?_==null||_():K==null||K(),z===void 0&&Qo(c),Y==null||Y(c)},ea=c=>{y||(c.key==="Enter"||c.key===" ")&&(c.preventDefault(),X())};m.useEffect(()=>{if(he.current!==r){const c=setTimeout(()=>{r?f==null||f():v==null||v()},200);return he.current=r,()=>clearTimeout(c)}},[r,f,v]);const oa=()=>te?te({isExpanded:r,disabled:y||!1,onClick:X,heading:t,description:l,leadIcon:ee}):e.jsxs(la,{$isExpanded:r,onClick:X,onKeyDown:ea,disabled:y,className:Po,style:Bo,"aria-expanded":r,"aria-controls":le,id:ce,children:[e.jsxs(pa,{children:[oe==="left"&&e.jsx(ue,{$isExpanded:r,"aria-hidden":"true",children:e.jsx(ge,{})}),e.jsxs(ha,{children:[e.jsxs(ga,{children:[ko&&e.jsx(ua,{"aria-hidden":"true",children:ee??e.jsx(ta,{})}),e.jsx(a,{variant:s,weight:h,as:"span",style:{whiteSpace:"nowrap"},children:t})]}),ae&&e.jsx(ya,{children:ae})]}),oe==="right"&&e.jsx(ue,{$isExpanded:r,"aria-hidden":"true",children:e.jsx(ge,{})})]}),l&&Q&&e.jsx("span",{id:pe,style:{width:"100%"},children:e.jsx(a,{variant:"body",as:"span",children:l})})]}),aa=()=>ie?ie({isExpanded:r,children:Z}):e.jsxs(ma,{$isExpanded:r,$hasFooter:ne,className:Oo,style:Ho,id:le,role:"region","aria-labelledby":ce,children:[U&&e.jsx(xa,{children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"12px"},children:[e.jsx(sa,{style:{width:32,height:32,animation:"spin 1s linear infinite"}}),e.jsx(a,{variant:"body",children:qo})]})}),x&&se&&!U&&e.jsxs(va,{role:"alert",children:[e.jsx(ia,{style:{width:20,height:20,flexShrink:0}}),e.jsx(a,{variant:"body",children:se})]}),de&&!U&&!x&&e.jsxs(fa,{children:[e.jsx(da,{style:{width:48,height:48,opacity:.5}}),e.jsx(a,{variant:"body",style:{opacity:.7},children:$o})]}),!de&&!x&&Z]}),na=()=>!ne||!r?null:re?re({footerText:V,footerActions:W}):e.jsxs(e.Fragment,{children:[Do&&e.jsx(Ta,{}),e.jsxs(ba,{className:Vo,style:Wo,children:[V&&e.jsx(a,{variant:"caption",as:"span",style:{whiteSpace:"nowrap"},children:V}),Ro&&W&&e.jsx(Ca,{children:W})]})]});return e.jsx(Zo,{ref:Xo,className:Fo,style:No,id:b,"aria-label":zo,"aria-labelledby":Uo,"aria-describedby":Yo||pe,...Ko,children:e.jsxs(ca,{$isExpanded:r,$disabled:y||!1,$isInvalid:x||!1,children:[oa(),aa(),na()]})})});i.displayName="Accordion";i.__docgenInfo={description:`Accordion - Enterprise-grade collapsible content container
...
Optional secondary text for additional context.`},showDescription:{required:!1,tsType:{name:"boolean"},description:`Show/hide the description text.
When false, description is hidden even if provided.
@default true`,defaultValue:{value:"true",computed:!1}},children:{required:!1,tsType:{name:"ReactNode"},description:`Content to display when expanded.
...
@default <CheckCircle /> (shown when showLeadIcon is true and no icon provided)`},showLeadIcon:{required:!1,tsType:{name:"boolean"},description:`Show/hide lead icon.
...
@default false`,defaultValue:{value:"false",computed:!1}},showFooterLine:{required:!1,tsType:{name:"boolean"},description:`Show/hide the divider line between content and footer.
@default true`,defaultValue:{value:"true",computed:!1}},showButtons:{required:!1,tsType:{name:"boolean"},description:`Show/hide the footer action buttons area.
When false, footerActions are hidden even if provided.
@default true`,defaultValue:{value:"true",computed:!1}},footerText:{required:!1,tsType:{name:"string"},description:`Footer text content.
...
Used for ARIA relationships.`}},composes:["Omit"]};const qa={title:"Components/Accordion",component:i,parameters:{layout:"padded",docs:{description:{component:`
# Accordion Component
...
}`,...(xe=(me=p.parameters)==null?void 0:me.docs)==null?void 0:xe.source}}};var fe,ve,be;C.parameters={...C.parameters,docs:{...(fe=C.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  args: {
    ...Default.args,
...
}`,...(be=(ve=C.parameters)==null?void 0:ve.docs)==null?void 0:be.source}}};var Ce,Te,we;T.parameters={...T.parameters,docs:{...(Ce=T.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    showLeadIcon: false
  }
}`,...(we=(Te=T.parameters)==null?void 0:Te.docs)==null?void 0:we.source}}};var Ae,je,Ie;w.parameters={...w.parameters,docs:{...(Ae=w.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  args: {
    heading: 'Expand Icon on Left',
...
}`,...(Ie=(je=w.parameters)==null?void 0:je.docs)==null?void 0:Ie.source}}};var Le,Ee,Se;A.parameters={...A.parameters,docs:{...(Le=A.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  args: {
    heading: 'Large Bold Heading',
...
}`,...(Se=(Ee=A.parameters)==null?void 0:Ee.docs)==null?void 0:Se.source}}};var ke,De,Re;j.parameters={...j.parameters,docs:{...(ke=j.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  args: {
    heading: 'Accordion Heading',
    leadIcon: <CheckCircleOutlined />,
    showLeadIcon: true,
...
}`,...(Re=(De=j.parameters)==null?void 0:De.docs)==null?void 0:Re.source}}};var Me,$e,qe;I.parameters={...I.parameters,docs:{...(Me=I.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  args: {
...
}`,...(qe=($e=I.parameters)==null?void 0:$e.docs)==null?void 0:qe.source}}};var Fe,Ne,Pe;L.parameters={...L.parameters,docs:{...(Fe=L.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    defaultExpanded: true,
    showFooter: true,
...
}`,...(Pe=(Ne=L.parameters)==null?void 0:Ne.docs)==null?void 0:Pe.source}}};var Be,Oe,He;E.parameters={...E.parameters,docs:{...(Be=E.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  args: {
...
}`,...(He=(Oe=E.parameters)==null?void 0:Oe.docs)==null?void 0:He.source}}};var Ve,We,ze;S.parameters={...S.parameters,docs:{...(Ve=S.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
  args: {
...
}`,...(ze=(We=S.parameters)==null?void 0:We.docs)==null?void 0:ze.source}}};var Ue,Ye,_e;k.parameters={...k.parameters,docs:{...(Ue=k.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  args: {
...
}`,...(_e=(Ye=k.parameters)==null?void 0:Ye.docs)==null?void 0:_e.source}}};var Ke,Xe,Ge;D.parameters={...D.parameters,docs:{...(Ke=D.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    disabled: true
  }
}`,...(Ge=(Xe=D.parameters)==null?void 0:Xe.docs)==null?void 0:Ge.source}}};var Je,Qe,Ze;R.parameters={...R.parameters,docs:{...(Je=R.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  render: () => {
...
}`,...(Ze=(Qe=R.parameters)==null?void 0:Qe.docs)==null?void 0:Ze.source}}};var eo,oo,ao;M.parameters={...M.parameters,docs:{...(eo=M.parameters)==null?void 0:eo.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: '16px'
...
}`,...(ao=(oo=M.parameters)==null?void 0:oo.docs)==null?void 0:ao.source}}};var no,to,io;$.parameters={...$.parameters,docs:{...(no=$.parameters)==null?void 0:no.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: '24px'
...
}`,...(io=(to=$.parameters)==null?void 0:to.docs)==null?void 0:io.source}}};var ro,so,co;q.parameters={...q.parameters,docs:{...(ro=q.parameters)==null?void 0:ro.docs,source:{originalSource:`{
  args: {
    heading: 'Loading Content',
...
}`,...(co=(so=q.parameters)==null?void 0:so.docs)==null?void 0:co.source}}};var lo,po,ho;F.parameters={...F.parameters,docs:{...(lo=F.parameters)==null?void 0:lo.docs,source:{originalSource:`{
  args: {
...
}`,...(ho=(po=F.parameters)==null?void 0:po.docs)==null?void 0:ho.source}}};var go,uo,yo;N.parameters={...N.parameters,docs:{...(go=N.parameters)==null?void 0:go.docs,source:{originalSource:`{
  args: {
...
}`,...(yo=(uo=N.parameters)==null?void 0:uo.docs)==null?void 0:yo.source}}};var mo,xo,fo;P.parameters={...P.parameters,docs:{...(mo=P.parameters)==null?void 0:mo.docs,source:{originalSource:`{
  args: {
    as: 'section',
    heading: 'Section Accordion',
...
}`,...(fo=(xo=P.parameters)==null?void 0:xo.docs)==null?void 0:fo.source}}};var vo,bo,Co;B.parameters={...B.parameters,docs:{...(vo=B.parameters)==null?void 0:vo.docs,source:{originalSource:`{
  render: () => {
...
}`,...(Co=(bo=B.parameters)==null?void 0:bo.docs)==null?void 0:Co.source}}};var To,wo,Ao;O.parameters={...O.parameters,docs:{...(To=O.parameters)==null?void 0:To.docs,source:{originalSource:`{
...
}`,...(Ao=(wo=O.parameters)==null?void 0:wo.docs)==null?void 0:Ao.source}}};var jo,Io,Lo;H.parameters={...H.parameters,docs:{...(jo=H.parameters)==null?void 0:jo.docs,source:{originalSource:`{
  render: () => {
...
}`,...(Lo=(Io=H.parameters)==null?void 0:Io.docs)==null?void 0:Lo.source}}};const Fa=["Default","Expanded","WithoutLeadIcon","ExpandIconLeft","CustomHeadingTypography","WithoutDescription","WithoutLabelsAndMetadata","WithFooter","NestedAccordions","DeeplyNestedAccordions","CustomLabelsAndMetadata","Disabled","Controlled","MultipleAccordions","ExpandIconPositionComparison","LoadingState","ErrorState","EmptyState","PolymorphicSection","ForwardRefExample","CustomSlots","EventCallbacks"];export{R as Controlled,A as CustomHeadingTypography,k as CustomLabelsAndMetadata,O as CustomSlots,S as DeeplyNestedAccordions,p as Default,D as Disabled,N as EmptyState,F as ErrorState,H as EventCallbacks,w as ExpandIconLeft,$ as ExpandIconPositionComparison,C as Expanded,B as ForwardRefExample,q as LoadingState,M as MultipleAccordions,E as NestedAccordions,P as PolymorphicSection,L as WithFooter,j as WithoutDescription,I as WithoutLabelsAndMetadata,T as WithoutLeadIcon,Fa as __namedExportsOrder,qa as default};
