import{j as e}from"./jsx-runtime-DztICxWZ.js";import{r as g}from"./index-Bv9Y92EF.js";import{a as n,b as i,T as Y,c as D,d as G,e as J}from"./TableToolbar-DNn88ULK.js";import{g as R}from"./styled-components.browser.esm-CVW2bgxI.js";import{T as t}from"./Typography-CidD3oMh.js";import{B as C}from"./Badge-FGqUbZvd.js";import{B as u}from"./Button-DlNRQx8j.js";import{I as h}from"./Icon-CnD2zmcO.js";import{C as X}from"./Checkbox-D2w4VPJI.js";import{T as ae}from"./TableSidePanel-XppAldF2.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./createSvgIcon-Ce6eLUkr.js";import"./Chip--FEJIdFJ.js";import"./WarningAmberOutlined-Chc0M3hO.js";import"./Close-CtL5j8iM.js";import"./Search-Bpcrs37S.js";import"./ExpandMore-Bd7rmlfk.js";import"./Settings-aYyvLXSG.js";import"./Home-Bococija.js";import"./InlineMessage-D0nF0rE-.js";import"./Select-NuoKoeUa.js";import"./FieldImportance-D7BkpLTs.js";import"./InputField-BAIr4sa2.js";import"./HelpingText-DBD3feHR.js";import"./RadioButton-DHcwHeDp.js";const te=R.tr`
  ...
  return (
    <table>
      ...
      <tbody>
        ...
        `}}}},w={render:()=>e.jsxs(S,{children:[e.jsx(t,{variant:"headingM",weight:"semibold",children:"Custom Table with Toolbar"}),e.jsx(t,{variant:"body",color:"secondary",children:"Table with custom toolbar using TableToolbar composition components."}),e.jsxs(Y,{children:[e.jsx(D,{align:"left",children:e.jsx(G,{children:"Employee Directory"})}),e.jsx(D,{align:"right",children:e.jsxs(J,{children:[e.jsxs(u,{variant:"secondary",size:"small",children:[e.jsx(h,{name:"FilterAlt",size:"small"})," Filter"]}),e.jsxs(u,{variant:"secondary",size:"small",children:[e.jsx(h,{name:"Download",size:"small"})," Export"]}),e.jsxs(u,{variant:"primary",size:"small",children:[e.jsx(h,{name:"Add",size:"small"})," Add Employee"]})]})})]}),e.jsx(x,{children:e.jsxs(f,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx(n,{label:"Name"}),e.jsx(n,{label:"Email"}),e.jsx(n,{label:"Status"})]})}),e.jsx("tbody",{children:b.map(l=>e.jsxs(v,{hoverable:!0,children:[e.jsx(i,{children:e.jsx(t,{variant:"body",weight:"semibold",children:l.name})}),e.jsx(i,{children:e.jsx(t,{variant:"body",children:l.email})}),e.jsx(i,{children:e.jsx(C,{label:l.status,type:l.status==="Active"?"success":"neutral"})})]},l.id))})]})})]}),parameters:{docs:{description:{story:"Custom table with toolbar built using TableToolbar composition components."},source:{code:`
import {
  TableToolbar,
  TableToolbarSection,
  TableToolbarTitle,
    ...
    return <TableWrapper>
        ...
        <TableContainer>
          <StyledTable>
            ...
            <tbody>
              {sampleEmployees.map(employee => <TableRow key={employee.id} hoverable clickable selected={selectedIds.includes(employee.id)} onClick={() => {}}>
                  <TableCell>
            ...
            <tbody>
              {sampleEmployees.map(employee => <TableRow key={employee.id} hoverable selected={selectedIds.includes(employee.id)}>
                  ...
                  justifyContent: 'flex-end'
                      ...
                      <Button variant="secondary" size="small" showLabel={false} leadingIcon={<Icon name="Edit" size="small" />} onClick={() => {}} aria-label="Edit">
                        Edit
                      </Button>
                      <Button variant="secondary" size="small" showLabel={false} leadingIcon={<Icon name="Delete" size="small" />} onClick={() => {}} aria-label="Delete">
                        Delete
                      </Button>
                    </div>
                  </TableCell>
