...
`,e.jsxs("div",{className:"stats-container",children:[e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-number",children:"1.7.2"}),e.jsx("div",{className:"stat-label",children:"Current Version"})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-number",children:"50+"}),e.jsx("div",{className:"stat-label",children:"Components"})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-number",children:"100%"}),e.jsx("div",{className:"stat-label",children:"TypeScript"})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-number",children:"WCAG 2.1"}),e.jsx("div",{className:"stat-label",children:"Accessible"})]})]}),`
`,e.jsx(s.hr,{}),`
`,e.jsx(s.h2,{id:"-current-version",children:"🚀 Current Version"}),`
`,e.jsxs("div",{className:"version-container",children:[e.jsxs("div",{className:"version-header",children:[e.jsx("div",{className:"version-number",children:"v1.7.2"}),e.jsx("div",{className:"version-date",children:"July 9, 2026"})]}),e.jsxs("div",{className:"version-content",children:[e.jsxs("div",{className:"change-section",children:[e.jsx("div",{className:"change-title",children:e.jsxs(s.p,{children:[e.jsx("span",{className:"change-icon",children:"✨"}),`
