import{j as t}from"./jsx-runtime-DztICxWZ.js";import{r as E}from"./index-Bv9Y92EF.js";import{g as l}from"./styled-components.browser.esm-CVW2bgxI.js";import{T as h}from"./Typography-CidD3oMh.js";const x=l.div`
  display: flex;
  align-items: center;
...
`,te=()=>t.jsx("svg",{viewBox:"0 0 12 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M10 3L4.5 8.5L2 6",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),re=()=>t.jsx("svg",{viewBox:"0 0 12 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M2 6H10",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),ne=()=>t.jsx("svg",{viewBox:"0 0 16 16",fill:"currentColor",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M8 0C3.6 0 0 3.6 0 8C0 12.4 3.6 16 8 16C12.4 16 16 12.4 16 8C16 3.6 12.4 0 8 0ZM8.8 12H7.2V7.2H8.8V12ZM8.8 5.6H7.2V4H8.8V5.6Z"})}),H=E.forwardRef(({as:e,label:r,size:n="default",checked:s=!1,indeterminate:w=!1,disabled:a=!1,isLoading:o=!1,isEmpty:L=!1,isInvalid:c=!1,errorMessage:j,emptyMessage:N="No options available",showTrailingIcon:S=!1,onChange:T,onFocus:A,onBlur:V,onKeyDown:D,onMouseEnter:d,onMouseLeave:u,onCheck:k,onUncheck:$,customLabel:p,customIcon:m,customTrailingIcon:f,className:g,inputClassName:W,labelClassName:F,iconClassName:B,style:y,maxWidth:v,name:z,value:K,id:P,...Z},_)=>{const O=E.useId(),C=P||O,b=e||"div";E.useEffect(()=>{s?k==null||k():$==null||$()},[s]);const G=i=>{a||o||T==null||T(i)},q=()=>{if(a||o)return;const i=document.getElementById(C);i&&i.click()},J=i=>{i.preventDefault(),q()},Q=()=>{if(p)return typeof p=="function"?p({label:r,checked:s,disabled:a||o||!1}):p;if(!r)return null;const i=a||o?"#A3A3A3":c?"var(--color-semantic-text-error)":"#1A1A1A";return t.jsx("label",{htmlFor:C,onClick:J,style:{cursor:a||o?"not-allowed":"pointer",userSelect:"none"},children:t.jsx(h,{variant:n==="large"?"body":"caption",className:F,style:{color:i,whiteSpace:"nowrap"},children:r})})},X=()=>m?typeof m=="function"?m({checked:s,disabled:a||o||!1}):m:w?t.jsx(re,{}):s&&t.jsx(te,{}),Y=()=>f?typeof f=="function"?f({disabled:a||o||!1}):f:t.jsx(ne,{});return o?t.jsx(x,{as:b,className:g,style:{...y,maxWidth:v},onMouseEnter:d,onMouseLeave:u,children:t.jsxs(R,{children:[t.jsx(ee,{children:t.jsx("svg",{viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("circle",{cx:"8",cy:"8",r:"6",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeDasharray:"9.42 9.42",children:t.jsx("animateTransform",{attributeName:"transform",type:"rotate",from:"0 8 8",to:"360 8 8",dur:"1s",repeatCount:"indefinite"})})})}),t.jsx(h,{variant:"caption",style:{color:"#737373"},children:"Loading..."})]})}):L?t.jsx(x,{as:b,className:g,style:{...y,maxWidth:v},onMouseEnter:d,onMouseLeave:u,children:t.jsx(h,{variant:"caption",style:{color:"#A3A3A3"},children:N})}):c&&j?t.jsx(x,{as:b,className:g,style:{...y,maxWidth:v},onMouseEnter:d,onMouseLeave:u,children:t.jsxs(R,{children:[t.jsx(M,{$size:n,$checked:!1,$disabled:!0,$isInvalid:!0,role:"presentation"}),t.jsx(h,{variant:"caption",weight:"medium",style:{color:"var(--color-semantic-text-error)"},children:j})]})}):t.jsxs(x,{as:b,className:g,style:{...y,maxWidth:v},onMouseEnter:d,onMouseLeave:u,children:[t.jsxs(R,{children:[t.jsx(I,{ref:_,id:C,checked:s,disabled:a,onChange:G,onFocus:A,onBlur:V,onKeyDown:D,name:z,value:K,"aria-checked":w?"mixed":s,"aria-invalid":c,"aria-disabled":a,$size:n,className:W,...Z}),t.jsx(M,{$size:n,$checked:s||w,$disabled:a,$isInvalid:c,onClick:q,role:"presentation",children:X()}),Q()]}),S&&t.jsx(U,{$size:n,$disabled:a,className:B,children:Y()})]})});H.displayName="Checkbox";H.__docgenInfo={description:"",methods:[],displayName:"Checkbox",props:{as:{required:!1,tsType:{name:"ReactElementType",raw:"React.ElementType"},description:`Polymorphic prop - change the root element type
...
@default false`,defaultValue:{value:"false",computed:!1}},indeterminate:{required:!1,tsType:{name:"boolean"},description:`Indeterminate state - shows minus icon (for "select all" scenarios)
