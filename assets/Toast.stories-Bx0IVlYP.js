import{j as t}from"./jsx-runtime-DztICxWZ.js";import{r as ae}from"./index-Bv9Y92EF.js";import{g as s}from"./styled-components.browser.esm-CVW2bgxI.js";import{B as ie}from"./Button-DlNRQx8j.js";import"./_commonjsHelpers-Cpj98o6Y.js";const ce=s.div`
  display: flex;
  align-items: center;
...
@default 'Button'`,defaultValue:{value:"'Button'",computed:!1}},onActionClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback when action button is clicked"},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback when close icon is clicked"},className:{required:!1,tsType:{name:"string"},description:"Additional CSS class"}}};const je={title:"Components/Toast",component:o,parameters:{layout:"centered",docs:{description:{component:`
# Toast
...
}`,...(j=(v=i.parameters)==null?void 0:v.docs)==null?void 0:j.source}}};var k,S,T;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    type: 'warning',
    style: 'default',
...
}`,...(L=($=u.parameters)==null?void 0:$.docs)==null?void 0:L.source}}};var E,V,A;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    type: 'info',
    style: 'default',
    text: 'Info notification'
  }
}`,...(A=(V=d.parameters)==null?void 0:V.docs)==null?void 0:A.source}}};var B,M,q;p.parameters={...p.parameters,docs:{...(B=p.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    type: 'warning',
    style: 'subdued',
    text: 'Warning notification'
...
}`,...(G=(Z=m.parameters)==null?void 0:Z.docs)==null?void 0:G.source}}};const ke=["Playground","WarningDefault","SuccessDefault","ErrorDefault","InfoDefault","WarningSubdued","SuccessSubdued","ErrorSubdued","InfoSubdued","AllVariants"];export{m as AllVariants,u as ErrorDefault,g as ErrorSubdued,d as InfoDefault,y as InfoSubdued,i as Playground,l as SuccessDefault,f as SuccessSubdued,c as WarningDefault,p as WarningSubdued,ke as __namedExportsOrder,je as default};
