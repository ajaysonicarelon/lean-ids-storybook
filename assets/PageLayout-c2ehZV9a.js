import{j as a}from"./jsx-runtime-DSvmvvsx.js";import{R as y}from"./index-B0WjJBI_.js";import{c as o}from"./styled-components.browser.esm-BIi91Tbq.js";import{T as v}from"./TopHeader-CP-oGfrE.js";import{S as L}from"./SideNavigation-CAxgutlO.js";import{B as I}from"./Breadcrumb-DEF5sgBW.js";import{F as U}from"./Footer-BmRSLCud.js";const s=o.div`
  display: flex;
...
`,O=o.p`
  ...
  color: ${({theme:e})=>e.colors.palette.neutral[600]};
  margin: 0;
`,d=({title:e,description:i,className:u})=>a.jsxs(F,{className:u,children:[a.jsx(M,{children:e}),i&&a.jsx(O,{children:i})]});d.__docgenInfo={description:"",methods:[],displayName:"PageHeader",props:{title:{required:!0,tsType:{name:"string"},description:"Page title/heading"},description:{required:!1,tsType:{name:"string"},description:"Short description of the page"},className:{required:!1,tsType:{name:"string"},description:"Optional className for custom styling"}}};const R=({variant:e,pageTitle:i,pageDescription:u,breadcrumbs:p,children:c,topHeader:n,sideNav:t,footer:r,className:P})=>{const[m,q]=y.useState((t==null?void 0:t.isPinned)||!1),C=g=>{var l;q(g),(l=t==null?void 0:t.onPinChange)==null||l.call(t,g)},B=e==="topbar-only"?x:e==="sidebar-only"?m?j:$:e==="topbar-sidebar"?m?A:T:x,f=()=>a.jsx(W,{"aria-label":"Breadcrumb",children:p.map((g,l)=>a.jsxs(y.Fragment,{children:[a.jsx(I,{...g}),l<p.length-1&&a.jsx(z,{children:"/"})]},l))}),h=()=>a.jsx(U,{lastUpdated:(r==null?void 0:r.lastUpdated)||"Sept 23, 2024",version:(r==null?void 0:r.version)||"1.0",feedbackText:(r==null?void 0:r.feedbackText)||"Send us a Feedback here",feedbackUrl:(r==null?void 0:r.feedbackUrl)||"#",onFeedbackClick:r==null?void 0:r.onFeedbackClick}),b=e==="sidebar-only"||e==="topbar-sidebar";return a.jsxs(B,{className:P,children:[b&&t&&a.jsx(L,{groups:t.groups,user:t.user,isPinned:m,onPinChange:C,expandMode:t.expandMode,toggleButtonPosition:t.toggleButtonPosition,toggleButtonOffset:t.toggleButtonOffset,toggleButtonSize:t.toggleButtonSize,toggleButtonIcon:t.toggleButtonIcon,customLogoUrl:t.customLogoUrl,logoAlignment:t.logoAlignment,logoPadding:t.logoPadding,showLabelsWhenCollapsed:t.showLabelsWhenCollapsed}),b?a.jsxs(S,{children:[e==="topbar-sidebar"&&n&&a.jsx(v,{mode:"light",appName:n.appName,menuItems:n.menuItems,userInitials:n.userInitials,userAvatarUrl:n.userAvatarUrl,showLogo:!1,showAppName:!!n.appName,showMenuItems:!!n.menuItems&&n.menuItems.length>0,showAvatar:!!n.userInitials,onAvatarClick:n.onAvatarClick,customLogoUrl:n.customLogoUrl}),a.jsxs(k,{children:[f(),a.jsx(d,{title:i,description:u}),c]}),h()]}):a.jsxs(a.Fragment,{children:[e==="topbar-only"&&n&&a.jsx(v,{mode:"dark",appName:n.appName,menuItems:n.menuItems,userInitials:n.userInitials,userAvatarUrl:n.userAvatarUrl,showLogo:n.showLogo!==!1,showAppName:!!n.appName,showMenuItems:!!n.menuItems&&n.menuItems.length>0,showAvatar:!!n.userInitials,onAvatarClick:n.onAvatarClick,customLogoUrl:n.customLogoUrl}),a.jsxs(k,{children:[f(),a.jsx(d,{title:i,description:u}),c]}),h()]})]})};R.__docgenInfo={description:"",methods:[],displayName:"PageLayout",props:{variant:{required:!0,tsType:{name:"union",raw:"'topbar-only' | 'sidebar-only' | 'topbar-sidebar'",elements:[{name:"literal",value:"'topbar-only'"},{name:"literal",value:"'sidebar-only'"},{name:"literal",value:"'topbar-sidebar'"}]},description:`Layout variant - determines which navigation components to show
