import{j as a}from"./jsx-runtime-DztICxWZ.js";import{A as i}from"./Avatar-DUNKMEJU.js";import{g as q}from"./styled-components.browser.esm-CVW2bgxI.js";import"./index-Bv9Y92EF.js";import"./_commonjsHelpers-Cpj98o6Y.js";const r=q.div`
  display: grid;
...
`,p=q.div`
  ...
  gap: 16px;
  align-items: center;
`,X={title:"Components/Avatar",component:i,parameters:{layout:"centered",docs:{description:{component:`
## Usage
...
Avatar component displays user profile pictures or initials in a circular container with various sizes and color options.
        `}}},tags:["autodocs"],argTypes:{size:{control:"radio",options:["large","medium","small"],description:"Size of the avatar (72px, 48px, or 32px)"},color:{control:"select",options:["default","purple","amber","cyan","lime","yellow","grey"],description:"Background color variant"},src:{control:"text",description:"Image URL for the avatar"},initials:{control:"text",description:"Initials to display (max 2 characters)"},disabled:{control:"boolean",description:"Disabled/greyed out state"}}},s={args:{size:"medium",color:"default",initials:"AA"}},e={render:()=>a.jsxs(r,{children:[a.jsx(i,{size:"large",color:"default",initials:"AA"}),a.jsx(i,{size:"medium",color:"default",initials:"AA"}),a.jsx(i,{size:"small",color:"default",initials:"AA"})]})},l={render:()=>a.jsxs(p,{children:[a.jsxs(r,{children:[a.jsx(i,{size:"large",color:"default",initials:"AA"}),a.jsx(i,{size:"medium",color:"default",initials:"AA"}),a.jsx(i,{size:"small",color:"default",initials:"AA"})]}),a.jsxs(r,{children:[a.jsx(i,{size:"large",color:"purple",initials:"AA"}),a.jsx(i,{size:"medium",color:"purple",initials:"AA"}),a.jsx(i,{size:"small",color:"purple",initials:"AA"})]}),a.jsxs(r,{children:[a.jsx(i,{size:"large",color:"amber",initials:"AA"}),a.jsx(i,{size:"medium",color:"amber",initials:"AA"}),a.jsx(i,{size:"small",color:"amber",initials:"AA"})]}),a.jsxs(r,{children:[a.jsx(i,{size:"large",color:"cyan",initials:"AA"}),a.jsx(i,{size:"medium",color:"cyan",initials:"AA"}),a.jsx(i,{size:"small",color:"cyan",initials:"AA"})]}),a.jsxs(r,{children:[a.jsx(i,{size:"large",color:"lime",initials:"AA"}),a.jsx(i,{size:"medium",color:"lime",initials:"AA"}),a.jsx(i,{size:"small",color:"lime",initials:"AA"})]}),a.jsxs(r,{children:[a.jsx(i,{size:"large",color:"yellow",initials:"AA"}),a.jsx(i,{size:"medium",color:"yellow",initials:"AA"}),a.jsx(i,{size:"small",color:"yellow",initials:"AA"})]}),a.jsxs(r,{children:[a.jsx(i,{size:"large",color:"grey",initials:"AA"}),a.jsx(i,{size:"medium",color:"grey",initials:"AA"}),a.jsx(i,{size:"small",color:"grey",initials:"AA"})]})]})},t={render:()=>a.jsxs(p,{children:[a.jsxs(r,{children:[a.jsx(i,{size:"large",src:"https://i.pravatar.cc/72?img=1",alt:"User 1"}),a.jsx(i,{size:"medium",src:"https://i.pravatar.cc/48?img=1",alt:"User 1"}),a.jsx(i,{size:"small",src:"https://i.pravatar.cc/32?img=1",alt:"User 1"})]}),a.jsxs(r,{children:[a.jsx(i,{size:"large",src:"https://i.pravatar.cc/72?img=5",alt:"User 2"}),a.jsx(i,{size:"medium",src:"https://i.pravatar.cc/48?img=5",alt:"User 2"}),a.jsx(i,{size:"small",src:"https://i.pravatar.cc/32?img=5",alt:"User 2"})]})]})},o={render:()=>a.jsxs(p,{children:[a.jsxs(r,{children:[a.jsx(i,{size:"large",initials:"AA",disabled:!0}),a.jsx(i,{size:"medium",initials:"AA",disabled:!0}),a.jsx(i,{size:"small",initials:"AA",disabled:!0})]}),a.jsxs(r,{children:[a.jsx(i,{size:"large",src:"https://i.pravatar.cc/72?img=3",alt:"User",disabled:!0}),a.jsx(i,{size:"medium",src:"https://i.pravatar.cc/48?img=3",alt:"User",disabled:!0}),a.jsx(i,{size:"small",src:"https://i.pravatar.cc/32?img=3",alt:"User",disabled:!0})]})]})},n={render:()=>a.jsxs(r,{children:[a.jsx(i,{size:"large",color:"purple",initials:"JD"}),a.jsx(i,{size:"medium",color:"cyan",initials:"SM"}),a.jsx(i,{size:"small",color:"amber",initials:"AB"})]})},c={args:{size:"large",color:"default",initials:"AA"}},m={args:{size:"medium",color:"purple",initials:"JD"}},A={args:{size:"small",color:"cyan",initials:"SM"}},d={args:{size:"medium",color:"purple",initials:"AS",onClick:()=>alert("Avatar clicked!")},parameters:{docs:{description:{story:"Avatar with onClick handler. Notice the pointer cursor on hover."}}}};var u,v,z;s.parameters={...s.parameters,docs:{...(u=s.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    size: 'medium',
    color: 'default',
    initials: 'AA'
